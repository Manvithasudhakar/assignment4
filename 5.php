...
<body style="background-color:pink;@import url('https://fonts.googleapis.com/css2?family=Pattaya&display=swap'); font-family: 'Pattaya', sans-serif;">
	<h1 style="color:black;font-style:italic;">
